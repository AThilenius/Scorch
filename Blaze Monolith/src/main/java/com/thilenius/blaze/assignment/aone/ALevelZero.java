...
// 5 : Turn Left/Right
public class ALevelZero extends BlazeLevel {
    ...
    public void grade(BFEProtos.BFESparkCommand request) {
        ...
        // Forward / Backward
        if (!m_moved && (request.getCommand() == BFEProtos.BFESparkCommand.CommandType.MOVE_FORWARD ||
        ...
        // Left / Right
        if (!m_turned && (request.getCommand() == BFEProtos.BFESparkCommand.CommandType.TURN_LEFT ||
